<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    ...
                    <p class="text-gray-600">"Leadership is not about being in charge. It's about taking care of those in your charge."</p>
                </div>
            </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-orange-600">{{ $unassignedTickets }}</p>
                            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <p class="text-sm text-gray-600 mb-2">Awaiting your approval</p>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span class="px-3 py-1 text-sm font-semibold text-blue-800 bg-blue-100 rounded-full">{{ $approvedEscalations }}</span>
                        </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            <h4 class="text-lg font-semibold text-gray-900">Unassigned</h4>
                            <span class="px-3 py-1 text-sm font-semibold text-yellow-800 bg-yellow-100 rounded-full">{{ $unassignedTickets }}</span>
                        </div>
                        <p class="text-sm text-gray-600 mb-2">Tickets needing assignment</p>
                        <a href="{{ route('manager.tickets.index', ['filter' => 'unassigned']) }}" class="text-sm text-indigo-600 hover:text-indigo-800 font-medium">View All →</a>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h4 class="text-lg font-semibold text-gray-900 mb-4">Active Agents ({{ $totalAgents }} Total)</h4>
                        <div class="space-y-3">
                            @forelse($ticketsByAgent as $agent)
                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                ...
                                <span class="px-3 py-1 text-sm font-bold text-indigo-800 bg-indigo-100 rounded-full">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="border-l-4 border-red-500 pl-3 py-2 bg-red-50">
                                <div class="flex items-center justify-between">
                                    <div class="flex-1">
                                        <a href="{{ route('manager.tickets.index', ['filter' => 'urgent']) }}" class="text-sm font-semibold text-gray-900 hover:text-indigo-600">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="space-y-3">
                            @forelse($unassignedTicketsList as $ticket)
                            <div class="border-l-4 border-yellow-500 pl-3 py-2 bg-yellow-50">
                                <div class="flex items-center justify-between">
                                    <div class="flex-1">
                                        <a href="{{ route('manager.tickets.index', ['filter' => 'unassigned']) }}" class="text-sm font-semibold text-gray-900 hover:text-indigo-600">
                                            #{{ $ticket->ticket_number }} - {{ Str::limit($ticket->title, 40) }}
                                        </a>
                                        <p class="text-xs text-gray-600 mt-1">
                                            {{ $ticket->user->name }} | 
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="border-l-4 border-orange-500 pl-3 py-2 bg-orange-50">
                                <div class="flex items-center justify-between">
                                    <div class="flex-1">
                                        <a href="{{ route('manager.tickets.index', ['filter' => 'pending_escalations']) }}" class="text-sm font-semibold text-gray-900 hover:text-indigo-600">
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="border-l-4 border-purple-500 pl-3 py-2 bg-purple-50">
                                <div class="flex items-center justify-between">
                                    <div class="flex-1">
                                        <a href="{{ route('manager.tickets.index', ['filter' => 'pending_reopens']) }}" class="text-sm font-semibold text-gray-900 hover:text-indigo-600">
    ...
    <div id="escalationsModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-2/3 shadow-lg rounded-md bg-white">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-600 mt-1">
                                ...
                                @if($escalation->ticket->assignedTo)
                                    Assigned to: {{ $escalation->ticket->assignedTo->name }} |
                                @endif
                                Requested by: {{ $escalation->requestedBy->name ?? 'Unknown' }} |
            ...
            <div class="mt-4 pt-4 border-t">
                <a href="{{ route('manager.tickets.index', ['filter' => 'pending_escalations']) }}" class="w-full block text-center px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700">
        ...
        <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-2/3 shadow-lg rounded-md bg-white">
            ...
            <div class="max-h-96 overflow-y-auto">
                ...
                <div class="border-l-4 border-purple-500 bg-purple-50 rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        <div class="flex-1">
                            <h4 class="font-semibold text-gray-900">#{{ $request->ticket->ticket_number }} - {{ $request->ticket->title }}</h4>
                            <p class="text-sm text-gray-600 mt-1">
                                Customer: {{ $request->ticket->user->name ?? 'Unknown' }} |
                                @if($request->ticket->assignedTo)
                                    Assigned to: {{ $request->ticket->assignedTo->name }} |
                                @endif
                                Requested by: {{ $request->requestedBy->name ?? 'Unknown' }} |
                                Priority: {{ $request->ticket->priority_relation->description ?? 'No Priority Set' }} |
                                Requested: {{ $request->requested_at ? $request->requested_at->diffForHumans() : 'Unknown' }}
                            </p>
                            <p class="text-sm text-gray-500 mt-1">{{ Str::limit($request->reason, 100) }}</p>
                        </div>
                    </div>
                </div>
                @empty
            ...
            <div class="mt-4 pt-4 border-t">
                <a href="{{ route('manager.tickets.index', ['filter' => 'pending_reopens']) }}" class="w-full block text-center px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700">
                    Go to Support Ticket
                </a>
            </div>
            @endif
    ...
    <div id="approvedEscalationsModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
        <div class="relative top-20 mx-auto p-5 border w-11/12 max-w-4xl shadow-lg rounded-md bg-white">
            <div class="mt-3">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-semibold text-gray-900">Approved Escalations</h3>
                ...
                <div class="space-y-3 max-h-96 overflow-y-auto">
                    @forelse($approvedEscalationsList as $escalation)
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-gray-600 mt-1">
                                    ...
                                    Requested by: {{ $escalation->requestedBy->name ?? 'Unknown' }} |
                                    Priority: {{ $escalation->ticket->priority_relation->description ?? 'No Priority Set' }} |
                                    Escalated: {{ $escalation->escalated_at ? $escalation->escalated_at->diffForHumans() : 'Unknown' }}
                                </p>
                                <p class="text-sm text-gray-500 mt-1">{{ Str::limit($escalation->reason, 100) }}</p>
                            </div>
                        </div>
                ...
                <div class="flex justify-end mt-4">
                    <a href="{{ route('manager.tickets.index', ['filter' => 'approved_escalations']) }}" class="bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700 transition">
                        Go to Support Ticket
                    </a>
                </div>
            </div>
